...
class __TwigTemplate_3562d787fa13fd5bf19853a2418398dda9a5550fd4777efdcd7b12d667a1fab5 extends \Twig\Template
{
    private $source;
...
<div class=\"row\">
    <form name=\"search\" method=\"get\" action=\"";
        ...
        <div class=\"row\">
            ";
        // line 6
        echo $this->env->getRuntime('Symfony\Component\Form\FormRenderer')->searchAndRenderBlock(twig_get_attribute($this->env, $this->source, (isset($context["form"]) || array_key_exists("form", $context) ? $context["form"] : (function () { throw new RuntimeError('Variable "form" does not exist.', 6, $this->source); })()), "search", []), 'widget');
        echo "
        </div>
        ...
        <div class=\"row\">
            ";
        // line 10
        echo $this->env->getRuntime('Symfony\Component\Form\FormRenderer')->searchAndRenderBlock(twig_get_attribute($this->env, $this->source, (isset($context["form"]) || array_key_exists("form", $context) ? $context["form"] : (function () { throw new RuntimeError('Variable "form" does not exist.', 10, $this->source); })()), "priceStart", []), 'widget', ["horizontal_input_wrapper_class" => "col-sm-3", "attr" => ["min" => 1, "class" => "form-control", "placeholder" => "Start from"]]);
        // line 14
        echo "

            ";
        // line 16
        echo $this->env->getRuntime('Symfony\Component\Form\FormRenderer')->searchAndRenderBlock(twig_get_attribute($this->env, $this->source, (isset($context["form"]) || array_key_exists("form", $context) ? $context["form"] : (function () { throw new RuntimeError('Variable "form" does not exist.', 16, $this->source); })()), "priceEnd", []), 'widget', ["horizontal_input_wrapper_class" => "col-sm-3", "attr" => ["min" => 1, "class" => "form-control", "placeholder" => "End to"]]);
        // line 20
        echo "
        </div>
        ...
        <div class=\"row\">
            ";
        // line 24
        echo $this->env->getRuntime('Symfony\Component\Form\FormRenderer')->searchAndRenderBlock(twig_get_attribute($this->env, $this->source, (isset($context["form"]) || array_key_exists("form", $context) ? $context["form"] : (function () { throw new RuntimeError('Variable "form" does not exist.', 24, $this->source); })()), "sort", []), 'widget', ["horizontal_input_wrapper_class" => "col-sm-3"]);
        echo "
        </div>
...
";
    ...
    {
        return array (  128 => 43,  113 => 41,  111 => 40,  108 => 39,  91 => 38,  86 => 35,  84 => 34,  71 => 24,  65 => 20,  63 => 16,  59 => 14,  57 => 10,  50 => 6,  45 => 4,  41 => 2,);
    }
...
", "@SonataDatagrid/Search/results.html.twig", "C:\\symfony\\htdocs\\guestbook\\vendor\\sonata-project\\datagrid-bundle\\src\\Resources\\views\\Search\\results.html.twig");
    }
}
