...
class srcApp_KernelDevDebugContainer extends Container
{
    ...
    public function __construct(array $buildParameters = [], $containerDir = __DIR__)
    {
        ...
        $this->fileMap = [
            'App\\Controller\\GuestAdminController' => 'getGuestAdminControllerService.php',
            'App\\Controller\\GuestBookController' => 'getGuestBookControllerService.php',
            'App\\Controller\\GuestController' => 'getGuestControllerService.php',
            ...
            'admin.guest' => 'getAdmin_GuestService.php',
            'admin.guest.template_registry' => 'getAdmin_Guest_TemplateRegistryService.php',
    ...
    {
        $a = new \Symfony\Component\Cache\Adapter\FilesystemAdapter('n2Ha+GeXDo', 0, ($this->targetDirs[0].'/pools'), new \Symfony\Component\Cache\Marshaller\DefaultMarshaller(NULL));
    ...
    {
        return $this->services['cache.system'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('+Fl3Rq-gJI', 0, $this->getParameter('container.build_id'), ($this->targetDirs[0].'/pools'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService())));
    }
    ...
    protected function getSonata_Admin_PoolService()
    {
        ...
        $instance->setAdminServiceIds([0 => 'admin.guest']);
        $instance->setAdminGroups(['admin' => ['label' => 'admin', 'label_catalogue' => 'SonataAdminBundle', 'icon' => '<i class="fa fa-folder"></i>', 'roles' => [], 'on_top' => false, 'keep_open' => false, 'items' => [0 => ['admin' => 'admin.guest', 'label' => 'Guest', 'route' => '', 'route_params' => [], 'route_absolute' => false]]]]);
        $instance->setAdminClasses(['App\\Entity\\Guest' => [0 => 'admin.guest']]);
    ...
    {
        return $this->privates['cache.annotations'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('jtr3dwEnZ1', 0, $this->getParameter('container.build_id'), ($this->targetDirs[0].'/pools'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService())));
    }
    ...
    {
        return $this->privates['cache.security_expression_language'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('ynFChDgoUF', 0, $this->getParameter('container.build_id'), ($this->targetDirs[0].'/pools'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService())));
    }
    ...
    {
        return $this->privates['cache.validator'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('lbWHyZB4W6', 0, $this->getParameter('container.build_id'), ($this->targetDirs[0].'/pools'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService())));
    }
    ...
    {
        return $this->privates['cache.webpack_encore'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('ez6M10T+6D', 0, $this->getParameter('container.build_id'), ($this->targetDirs[0].'/pools'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService())));
    }
    ...
    protected function getDefaultParameters()
    {
        return [
            ...
            'sonata.core.form.types' => [
                0 => 'App\\Form\\Guest1Type',
                1 => 'App\\Form\\GuestType',
                2 => 'form.type.form',
                3 => 'form.type.choice',
                4 => 'form.type.entity',
                5 => 'sonata.core.form.type.array_legacy',
                6 => 'sonata.core.form.type.boolean_legacy',
                7 => 'sonata.core.form.type.collection_legacy',
                8 => 'sonata.core.form.type.translatable_choice',
                9 => 'sonata.core.form.type.date_range_legacy',
                10 => 'sonata.core.form.type.datetime_range_legacy',
                11 => 'sonata.core.form.type.date_picker_legacy',
                12 => 'sonata.core.form.type.datetime_picker_legacy',
                13 => 'sonata.core.form.type.date_range_picker_legacy',
                14 => 'sonata.core.form.type.datetime_range_picker_legacy',
                15 => 'sonata.core.form.type.equal_legacy',
                16 => 'sonata.core.form.type.color_selector',
                17 => 'sonata.core.form.type.color_legacy',
                18 => 'sonata.core.form.type.array',
                19 => 'sonata.core.form.type.boolean',
                20 => 'sonata.core.form.type.collection',
                21 => 'sonata.core.form.type.date_range',
                22 => 'sonata.core.form.type.datetime_range',
                23 => 'sonata.core.form.type.date_picker',
                24 => 'sonata.core.form.type.datetime_picker',
                25 => 'sonata.core.form.type.date_range_picker',
                26 => 'sonata.core.form.type.datetime_range_picker',
                27 => 'sonata.core.form.type.equal',
                28 => 'sonata.block.form.type.block',
                29 => 'sonata.block.form.type.container_template',
                30 => 'sonata.admin.form.type.admin',
                31 => 'sonata.admin.form.type.model_choice',
                32 => 'sonata.admin.form.type.model_list',
                33 => 'sonata.admin.form.type.model_reference',
                34 => 'sonata.admin.form.type.model_hidden',
                35 => 'sonata.admin.form.type.model_autocomplete',
                36 => 'sonata.admin.form.type.collection',
                37 => 'sonata.admin.doctrine_orm.form.type.choice_field_mask',
            ...
            'console.command.ids' => [
                ...
                14 => 'console.command.public_alias.Sonata\\CoreBundle\\Command\\SonataDumpDoctrineMetaCommand',
                15 => 'console.command.public_alias.Sonata\\CoreBundle\\Command\\SonataListFormMappingCommand',
                16 => 'console.command.public_alias.Sonata\\BlockBundle\\Command\\DebugBlocksCommand',
                17 => 'Sonata\\AdminBundle\\Command\\CreateClassCacheCommand',
                18 => 'Sonata\\AdminBundle\\Command\\ExplainAdminCommand',
                19 => 'Sonata\\AdminBundle\\Command\\GenerateAdminCommand',
                20 => 'Sonata\\AdminBundle\\Command\\GenerateObjectAclCommand',
                21 => 'Sonata\\AdminBundle\\Command\\ListAdminCommand',
                22 => 'Sonata\\AdminBundle\\Command\\SetupAclCommand',
            ],
        ];
    }
}
