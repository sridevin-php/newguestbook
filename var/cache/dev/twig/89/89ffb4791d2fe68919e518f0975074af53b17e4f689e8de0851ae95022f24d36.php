...
class __TwigTemplate_0ef389245d7f28b0761f202d9f224deafdda619583ca98a2a7e401242accf87a extends \Twig\Template
{
    private $source;
...
(isset($context["admin"]) || array_key_exists("admin", $context) ? $context["admin"] : (function () { throw new RuntimeError('Variable "admin" does not exist.', 44, $this->source); })())]));
    ...
    public function block_list_table($context, array $blocks = [])
    {
        ...
        <div class=\"box box-primary\">
            <div class=\"box-header\">
                <h1 class=\"box-title\">
                    ";
        // line 53
        echo twig_escape_filter($this->env, $this->extensions['Symfony\Bridge\Twig\Extension\TranslationExtension']->trans("element.tree_site_label", [], twig_get_attribute($this->env, $this->source, (isset($context["admin"]) || array_key_exists("admin", $context) ? $context["admin"] : (function () { throw new RuntimeError('Variable "admin" does not exist.', 53, $this->source); })()), "translationdomain", [])), "html", null, true);
        echo "
                    <div class=\"btn-group\">
                        <button type=\"button\" class=\"btn btn-default dropdown-toggle\" data-toggle=\"dropdown\">
                            <strong class=\"text-info\">";
        // line 56
        echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, (isset($context["currentSite"]) || array_key_exists("currentSite", $context) ? $context["currentSite"] : (function () { throw new RuntimeError('Variable "currentSite" does not exist.', 56, $this->source); })()), "name", []), "html", null, true);
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["context"]) {
            ...
            // line 67
            echo "                                        ";
            echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, (isset($context["site"]) || array_key_exists("site", $context) ? $context["site"] : (function () { throw new RuntimeError('Variable "site" does not exist.', 67, $this->source); })()), "name", []), "html", null, true);
            echo "
                                    </a>
                                </li>
                            ";
...
";
    ...
    public function macro_navigate_child($__collection__ = null, $__admin__ = null, $__root__ = null, ...$__varargs__)
    {
        ...
        ";
            // line 21
            $context['_parent'] = $context;
            $context['_seq'] = twig_ensure_traversable((isset($context["collection"]) || array_key_exists("collection", $context) ? $context["collection"] : (function () { throw new RuntimeError('Variable "collection" does not exist.', 21, $this->source); })()));
            foreach ($context['_seq'] as $context["_key"] => $context["element"]) {
                if ( !(isset($context["root"]) || array_key_exists("root", $context) ? $context["root"] : (function () { throw new RuntimeError('Variable "root" does not exist.', 21, $this->source); })())) {
                    // line 22
                    echo "            <li>
                <div class=\"sonata-tree__item\">
                    ...
                    // line 26
                    echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, (isset($context["admin"]) || array_key_exists("admin", $context) ? $context["admin"] : (function () { throw new RuntimeError('Variable "admin" does not exist.', 26, $this->source); })()), "generateObjectUrl", [0 => "edit", 1 => $context["element"]], "method"), "html", null, true);
                    echo "\">";
                    ...
                    // line 28
                    echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, (isset($context["admin"]) || array_key_exists("admin", $context) ? $context["admin"] : (function () { throw new RuntimeError('Variable "admin" does not exist.', 28, $this->source); })()), "generateObjectUrl", [0 => "edit", 1 => $context["element"]], "method"), "html", null, true);
...
";
    ...
    {
        return array (  242 => 37,  234 => 35,  228 => 33,  226 => 32,  222 => 30,  218 => 29,  214 => 28,  210 => 27,  204 => 26,  201 => 25,  197 => 24,  193 => 22,  188 => 21,  181 => 20,  161 => 19,  146 => 76,  139 => 71,  128 => 67,  122 => 63,  120 => 62,  116 => 61,  113 => 60,  109 => 59,  103 => 56,  97 => 53,  91 => 49,  82 => 48,  72 => 44,  71 => 43,  69 => 41,  60 => 40,  49 => 16,  47 => 18,  35 => 16,);
    }
...
{% endblock %}
", "@SonataAdmin/CRUD/tree.html.twig", "C:\\symfony\\htdocs\\guestbook\\vendor\\sonata-project\\admin-bundle\\src\\Resources\\views\\CRUD\\tree.html.twig");
    }
}
