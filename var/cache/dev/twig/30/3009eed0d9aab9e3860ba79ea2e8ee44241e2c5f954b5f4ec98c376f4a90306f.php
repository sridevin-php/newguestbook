...
class __TwigTemplate_082b6670e2a029196489910cdd0b079a0717f264b0bd5a3043fd9d88fe68cdc2 extends \Twig\Template
{
    private $source;
...
";
        ...
        $context['_seq'] = twig_ensure_traversable(twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, (isset($context["admin"]) || array_key_exists("admin", $context) ? $context["admin"] : (function () { throw new RuntimeError('Variable "admin" does not exist.', 12, $this->source); })()), "datagrid", []), "results", []));
        $context['loop'] = [
...
";
    ...
    {
        return array (  66 => 15,  64 => 14,  61 => 13,  44 => 12,  41 => 11,);
    }
...
{% endfor %}
", "@SonataAdmin/CRUD/list_outer_rows_list.html.twig", "C:\\symfony\\htdocs\\guestbook\\vendor\\sonata-project\\admin-bundle\\src\\Resources\\views\\CRUD\\list_outer_rows_list.html.twig");
    }
}
