...
class __TwigTemplate_5d27658836ca44655ffb18d4c8f09f46b0f3815e688786afa9fed5d91c14dad0 extends \Twig\Template
{
    private $source;
    ...
    <div class=\"row\">
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["revision"]) {
            // line 36
            echo "                            <tr class=\"";
            if ((((isset($context["currentRevision"]) || array_key_exists("currentRevision", $context) ? $context["currentRevision"] : (function () { throw new RuntimeError('Variable "currentRevision" does not exist.', 36, $this->source); })()) != false) && (twig_get_attribute($this->env, $this->source, $context["revision"], "rev", []) == twig_get_attribute($this->env, $this->source, (isset($context["currentRevision"]) || array_key_exists("currentRevision", $context) ? $context["currentRevision"] : (function () { throw new RuntimeError('Variable "currentRevision" does not exist.', 36, $this->source); })()), "rev", [])))) {
                echo "current-revision";
            }
            echo "\">
                                <td>";
            // line 37
            echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, $context["revision"], "rev", []), "html", null, true);
            echo "</td>
                                <td>";
            // line 38
            $this->loadTemplate($this->extensions['Sonata\AdminBundle\Twig\Extension\TemplateRegistryExtension']->getAdminTemplate("history_revision_timestamp", twig_get_attribute($this->env, $this->source, (isset($context["admin"]) || array_key_exists("admin", $context) ? $context["admin"] : (function () { throw new RuntimeError('Variable "admin" does not exist.', 38, $this->source); })()), "code", [])), "@SonataAdmin/CRUD/base_history.html.twig", 38)->display($context);
            echo "</td>
                                <td>";
            // line 39
            echo twig_escape_filter($this->env, ((twig_get_attribute($this->env, $this->source, $context["revision"], "username", [], "any", true, true)) ? (_twig_default_filter(twig_get_attribute($this->env, $this->source, $context["revision"], "username", []), $this->extensions['Symfony\Bridge\Twig\Extension\TranslationExtension']->trans("label_unknown_user", [], "SonataAdminBundle"))) : ($this->extensions['Symfony\Bridge\Twig\Extension\TranslationExtension']->trans("label_unknown_user", [], "SonataAdminBundle"))), "html", null, true);
            echo "</td>
                                <td><a href=\"";
            // line 40
            echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, (isset($context["admin"]) || array_key_exists("admin", $context) ? $context["admin"] : (function () { throw new RuntimeError('Variable "admin" does not exist.', 40, $this->source); })()), "generateObjectUrl", [0 => "history_view_revision", 1 => (isset($context["object"]) || array_key_exists("object", $context) ? $context["object"] : (function () { throw new RuntimeError('Variable "object" does not exist.', 40, $this->source); })()), 2 => ["revision" => twig_get_attribute($this->env, $this->source, $context["revision"], "rev", [])]], "method"), "html", null, true);
            ...
            echo "</a></td>
                                <td>
                                    ";
            // line 42
            if ((((isset($context["currentRevision"]) || array_key_exists("currentRevision", $context) ? $context["currentRevision"] : (function () { throw new RuntimeError('Variable "currentRevision" does not exist.', 42, $this->source); })()) == false) || (twig_get_attribute($this->env, $this->source, $context["revision"], "rev", []) == twig_get_attribute($this->env, $this->source, (isset($context["currentRevision"]) || array_key_exists("currentRevision", $context) ? $context["currentRevision"] : (function () { throw new RuntimeError('Variable "currentRevision" does not exist.', 42, $this->source); })()), "rev", [])))) {
                // line 43
                echo "                                        /
                                    ";
            } else {
...
";
    ...
    {
        return array (  194 => 50,  178 => 47,  168 => 45,  164 => 43,  162 => 42,  153 => 40,  149 => 39,  145 => 38,  141 => 37,  134 => 36,  117 => 35,  110 => 31,  106 => 30,  102 => 29,  98 => 28,  94 => 27,  84 => 19,  75 => 18,  65 => 15,  56 => 14,  35 => 12,);
    }
...
{% endblock %}
", "@SonataAdmin/CRUD/base_history.html.twig", "C:\\symfony\\htdocs\\guestbook\\vendor\\sonata-project\\admin-bundle\\src\\Resources\\views\\CRUD\\base_history.html.twig");
    }
}
