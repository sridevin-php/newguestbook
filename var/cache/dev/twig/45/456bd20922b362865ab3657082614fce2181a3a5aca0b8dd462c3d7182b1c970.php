...
class __TwigTemplate_b6d5e48b5d0ab39ab05a0cd942a1b3a44c7be05baa35ff96b7165974d4ef17fc extends \Twig\Template
{
    private $source;
...
<label<?php if (\$label_attr) { echo ' '.\$view['form']->block(\$form, 'attributes', ['attr' => \$label_attr]); } ?>><?php echo \$view->escape(false !== \$translation_domain ? \$view['translator']->trans(\$label, [], \$translation_domain) : \$label) ?></label>
<?php endif ?>
", "@Framework/Form/form_label.html.php", "C:\\symfony\\htdocs\\guestbook\\vendor\\symfony\\framework-bundle\\Resources\\views\\Form\\form_label.html.php");
    }
}
