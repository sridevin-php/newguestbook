...
// Returns the public 'admin.guest' autowired service.
...
include_once $this->targetDirs[3].'\\src\\Admin\\GuestAdmin.php';
...
$this->factories['admin.guest'] = function () {
    $instance = new \App\Admin\GuestAdmin('admin.guest', 'App\\Entity\\Guest', 'App\\Controller\\GuestAdminController');
    ...
    $instance->setLabel('Guest');
    $instance->showMosaicButton(true);
    $instance->setTemplateRegistry(($this->services['admin.guest.template_registry'] ?? $this->load('getAdmin_Guest_TemplateRegistryService.php')));
...
return $this->factories['admin.guest']();
