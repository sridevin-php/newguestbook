...
return $this->privates['security.authentication.provider.guard.main'] = new \Symfony\Component\Security\Guard\Provider\GuardAuthenticationProvider(new RewindableGenerator(function () {
    yield 0 => ($this->privates['App\\Security\\LoginFormAuthendicatorAuthenticator'] ?? $this->load('getLoginFormAuthendicatorAuthenticatorService.php'));
}, 1), ($this->privates['security.user.provider.concrete.my_provider'] ?? $this->load('getSecurity_User_Provider_Concrete_MyProviderService.php')), 'main', ($this->privates['security.user_checker'] ?? ($this->privates['security.user_checker'] = new \Symfony\Component\Security\Core\User\UserChecker())));
