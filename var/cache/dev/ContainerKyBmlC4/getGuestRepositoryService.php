...
// Returns the private 'App\Repository\GuestRepository' shared autowired service.
...
include_once $this->targetDirs[3].'\\src\\Repository\\GuestRepository.php';

return $this->privates['App\\Repository\\GuestRepository'] = new \App\Repository\GuestRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
