...
class __TwigTemplate_d858488867e81459a0e5a774409752df4a7ecde13efe3228c963f70a12411a42 extends \Twig\Template
{
    private $source;
...
";
    ...
    public function block_field_row($context, array $blocks = [])
    {
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["code"]) {
            // line 11
            echo "        ";
            $context["show_group"] = twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, (isset($context["admin"]) || array_key_exists("admin", $context) ? $context["admin"] : (function () { throw new RuntimeError('Variable "admin" does not exist.', 11, $this->source); })()), "showgroups", []), $context["code"], [], "array");
            // line 12
            echo "
        <div class=\"";
            // line 13
            ...
            echo " ";
            echo (((isset($context["no_padding"]) || array_key_exists("no_padding", $context) ? $context["no_padding"] : (function () { throw new RuntimeError('Variable "no_padding" does not exist.', 13, $this->source); })())) ? ("nopadding") : (""));
            echo "\">
            <div class=\"";
            // line 14
            echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, (isset($context["show_group"]) || array_key_exists("show_group", $context) ? $context["show_group"] : (function () { throw new RuntimeError('Variable "show_group" does not exist.', 14, $this->source); })()), "box_class", []), "html", null, true);
            echo "\">
            ...
            // line 25
            $context['_parent'] = $context;
            $context['_seq'] = twig_ensure_traversable(twig_get_attribute($this->env, $this->source, (isset($context["show_group"]) || array_key_exists("show_group", $context) ? $context["show_group"] : (function () { throw new RuntimeError('Variable "show_group" does not exist.', 25, $this->source); })()), "fields", []));
            $context['loop'] = [
              'parent' => $context['_parent'],
              'index0' => 0,
              'index'  => 1,
    ...
    public function block_show_field($context, array $blocks = [])
    {
        ...
        echo "                                <tr class=\"sonata-ba-view-container\">
                                    ";
        // line 28
        if (twig_get_attribute($this->env, $this->source, ($context["elements"] ?? null), (isset($context["field_name"]) || array_key_exists("field_name", $context) ? $context["field_name"] : (function () { throw new RuntimeError('Variable "field_name" does not exist.', 28, $this->source); })()), [], "array", true, true)) {
            // line 29
            echo "                                        ";
            echo $this->extensions['Sonata\AdminBundle\Twig\Extension\SonataAdminExtension']->renderViewElement($this->env, twig_get_attribute($this->env, $this->source, (isset($context["elements"]) || array_key_exists("elements", $context) ? $context["elements"] : (function () { throw new RuntimeError('Variable "elements" does not exist.', 29, $this->source); })()), (isset($context["field_name"]) || array_key_exists("field_name", $context) ? $context["field_name"] : (function () { throw new RuntimeError('Variable "field_name" does not exist.', 29, $this->source); })()), [], "array"), (isset($context["object"]) || array_key_exists("object", $context) ? $context["object"] : (function () { throw new RuntimeError('Variable "object" does not exist.', 29, $this->source); })()));
            echo "
                                    ";
        }
        // line 31
...
";
    ...
    {
        return array (  253 => 5,  250 => 4,  227 => 3,  216 => 31,  210 => 29,  208 => 28,  205 => 27,  196 => 26,  183 => 18,  174 => 17,  147 => 34,  133 => 33,  130 => 26,  113 => 25,  106 => 20,  104 => 17,  98 => 14,  92 => 13,  89 => 12,  86 => 11,  68 => 10,  50 => 9,  47 => 8,  44 => 2,);
    }

    public function getSourceContext()
    {
        return new Source("{# NEXT_MAJOR: remove this template #}
...
{% block field_row %}
    ...
    {% endfor %}
{% endblock %}
", "@SonataAdmin/CRUD/base_show_macro.html.twig", "C:\\symfony\\htdocs\\guestbook\\vendor\\sonata-project\\admin-bundle\\src\\Resources\\views\\CRUD\\base_show_macro.html.twig");
    }
}
